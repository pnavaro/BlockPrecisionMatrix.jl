...
source('~/Dropbox/projet spectres/FDA-VisiteA.Pini/simulation data/FonctionsSimu.R')
source('~/Dropbox/projet spectres/FDA-VisiteA.Pini/code_BlockCovarianceTest/utilities.R', echo = TRUE)
#source('~/Dropbox/projet spectres/FDA-VisiteA.Pini/code_BlockCovarianceTest/blocks_loop.R', echo = TRUE)
source('~/Dropbox/projet spectres/FDA-VisiteA.Pini/code_BlockCovarianceTest/Precision_IWT_function.R', echo=TRUE)
