...
source('~/Documents/code_BlockCovarianceTest/FonctionsSimu.R')
#source('~/Dropbox/code_BlockCovarianceTest/blocks_loop.R', echo = TRUE)
source('~/Documents/code_BlockCovarianceTest/Precision_IWT_function.R', echo=TRUE)
source('~/Documents/code_BlockCovarianceTest/utilities.R', echo = TRUE)
